...
class MonthlySalesContainer extends StatefulWidget {
  MonthlySalesContainer({Key? key, this.title, this.shopname, this.location})
      : super(key: key);
...
class _MyShoppingPageState extends State<MonthlySalesContainer>
  ...
  Widget buildPageView() {
    return PageView(
      ...
      children: <Widget>[
        KeepAlivePage(
            child: MonthlySalesRecords(
          shopname: widget.shopname,
          location: widget.location,
        )),
        KeepAlivePage(
            child: MonthlySalesCharts(
          shopname: widget.shopname,
          location: widget.location,
        )),
      ],
