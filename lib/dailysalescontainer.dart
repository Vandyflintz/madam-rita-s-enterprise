...
import 'dailysaleschart.dart';
import 'dailysalesrecord.dart';
...
class DailySalesContainer extends StatefulWidget {
  DailySalesContainer({required Key key, required this.title, required this.shopname, required this.location})
      : super(key: key);
...
class _MyShoppingPageState extends State<DailySalesContainer>
