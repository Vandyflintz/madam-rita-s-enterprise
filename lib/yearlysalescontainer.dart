...
import 'yearlysaleschart.dart';
import 'yearlysalesrecord.dart';
...
class YearlySalesContainer extends StatefulWidget {
  YearlySalesContainer({Key? key, this.title, this.shopname, this.location})
      : super(key: key);
...
class _MyShoppingPageState extends State<YearlySalesContainer>
  ...
  Widget buildPageView() {
    return PageView(
      ...
      children: <Widget>[
        KeepAlivePage(
            child: YearlySalesRecords(
          shopname: widget.shopname,
          location: widget.location,
        )),
        KeepAlivePage(
            child: YearlySalesCharts(
          shopname: widget.shopname,
          location: widget.location,
        )),
      ],
